...
Versi terkini perkakas-perkakas tersebut pada saat artikel ini ditulis dapat ditemukan pada halaman unduh di [**situs Go**](https://go.dev/dl/go1.15.2.linux-amd64.tar.gz).
